...
// unsigned long ConnectStart_ms = 0;
...
//     String led1 = LED1State ? "ON" : "OFF";
//     String led2 = LED2State ? "ON" : "OFF";
...
//             else if (millis() - ConnectStart_ms > 10000) { // timeout 10s
